function [results,bms_results] = fit_models_rt(models, data, lb, save_mat,savepath)
%{
...
if save_mat
    save(savepath,'results','bms_results');
    %save('models_rt.mat','results','bms_results'); % 8 non-reduced models
end
end