var instructions = {
  ...
  pages: [
    // Welcome (page 1)
    '<p class="center-content"><b>Welcome to Part 2! </b> </p>' +
    '<p class="center-content">This is a refresher of the instructions for this study. The instructions are the same as Part 1, except that the pictures in this part will change.</p>' +
    ...
    // Instructions (page 2)
    '<p class="center-content"> <b>The instructions are the same for each part (1-4) of the study.</b> </p>' +
    ...
    '<p class="center-content">Here are some examples of pictures you will see in Part 2 of the study: </p>' +
    ...
    //Instructions (page 7)
    '<p class="center-content"> Again, the experiment will have 4 parts. After each part, your webpage will be automatically redirected to the next part.</p>' + 
    '<p class="center-content"> These instructions will be repeated at the beginning of each experiment part.</p>',
    '<p> Click "Next" to begin Part 2!</p>',
  ],
