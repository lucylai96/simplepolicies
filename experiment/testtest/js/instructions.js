var instructions = {
  ...
  pages: [
    ...
    '<p class="center-content">Here are some examples of pictures you will see in this part of the study: </p>' +
    '<p> <img src= img/land1.png style="width:150px;"> <img src= img/land2.png style="width:150px;"> <img src= img/land3.png style="width:150px;"></p>',
    // Instructions (page 5)
    ...
    '<p> <img src= img/land3.png style="border:14px solid green; width:150px; height:150px;"></p>'+ 
    ...
    '<p> <img src= img/land3.png style="border:14px solid red; width:150px; height:150px;"> </p>'+
