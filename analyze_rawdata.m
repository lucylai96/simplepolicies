...
switch experiment
    ...
    case 'data'
        ...
        subj4 = {'A2AP9F2LCG5GV8','A3774HPOUKYTX7','A3LIRS1WMRIP9P','ACJNWSBIVI46H',...
            ...
            'A27LCUA35LPVM8','AS7R0KA3QNVKE','ANOPPPGFNTUPN','A36470UBRH28GO'}; % landing3.html 
        ...
        subj7 = {'A1Z6RO9XS6SQDD','ALVNMQMD3Q3ZE','A3RTW9UWYKSNWX','A32GQGD6EUJGDJ',...
            ...
            'A1F8MH33EFT5VQ','A2APG8MSLJ6G2K','A334VWE4QGAZFR','A3O2D2BUS92BCA','A3L8LSM7V7KX3T'}; % landing3.html
       
        subj = [subj1 subj2 subj4 subj5 subj6 subj7];
        ...
        for s = 1:length(subj)
            ...
            for f = 1:length(folder)
                ...
                data(s).bonus = round(mean(data(s).pcorr)*4, 2);
